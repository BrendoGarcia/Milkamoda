document.addEventListener("DOMContentLoaded", function() {
  ...
  carrinho.appendChild(botaoFinalizarCompra);
    ...
    botaocencelar.classList.add("botaoFinalizar");
  ...
  imagemCarinho.addEventListener("click", function() {
    ...
    document.querySelector('.resumo-carrinho').style.display = 'grid'; // Mostra o resumo do carrinho ao clicar no carrinho
  ...
  function calcularSubtotal() {
    ...
    botaoFinalizarCompra.style.display = subtotal > 0 ? "" : "none";
    botaocencelar.style.display = subtotal > 0 ? "" : "none";
  }
